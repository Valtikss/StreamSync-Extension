...
(function (g) {
  g.SS_LOCALES = {
    fr: {
      ...
      'account.login.altHint': 'Rien ne s\'ouvre ?',
      'account.login.altCta': 'Ouvrir dans un onglet',
      'account.login.errGeneric': 'Connexion échouée. Réessaie ou ouvre la connexion dans un onglet.',
      'account.login.errTimeout': 'La fenêtre de connexion ne s\'est pas ouverte. Essaie d\'ouvrir dans un onglet.',
    ...
    en: {
      ...
      'account.login.altHint': 'Nothing opens?',
      'account.login.altCta': 'Open in a tab',
      'account.login.errGeneric': 'Sign-in failed. Retry or open it in a tab.',
      'account.login.errTimeout': 'The sign-in window didn\'t open. Try opening in a tab.',
